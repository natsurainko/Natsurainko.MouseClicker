    ...
    public class KeyboardHook
    {
        ...
        public void Start()
        {
            ...
            if (hKeyboardHook == 0)
            {
                ...
                hKeyboardHook = SetWindowsHookEx(WH_KEYBOARD_LL, KeyboardHookProcedure, GetModuleHandle("user32"), 0);

                //62行已修改,执行:墨汁Mozhi 环境未改变
                #region 墨汁Mozhi 核准修改 0引用添加/删改  2022年1月27日00点18分
